...
console.log("AALLLLLLLLLLLLLLLLLLLLLLLLLLLLLLGOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOoo")
logger.err({}, "AAAAAAALGO");
if (process.env['OPENID_ENABLED'] === 'true') {
  console.log("OPPEEEEEEEEEEEEEEEEENIDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDdddd")
logger.err({}, "OOPENDI");
  ...
  passport.use(new OpenIDConnectStrategy(
    ...
    async function verify(issuer, profile, cb) {
      ...
      const userDetails = {
        ...
        password: await genPass(64) // won't be used anyways, it's an external user
      };
